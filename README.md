...
![Alt text](Images/Black_Body_Heater_Control.png)
...
The microcontroller will be programmed over usb with exposed pads for uart programming in case there is issues with that. It interfaces with the temperature sensor board through an SPI connector with 3 cs pins for 3 temperature probes. This interface, along with all others, is done using molex connectors as they can be sampled for free.
